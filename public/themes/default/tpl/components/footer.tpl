        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="{{ url('/stats') }}" class="text-secondary text-decoration-none">Статистика</a></li>
                    <li><a href="{{ url('/bans') }}" class="text-secondary text-decoration-none">Бан-лист</a></li>
                </ul>
            </div>
            <div class="col-md-4 mb-3">
                <h5>Контакты</h5>
