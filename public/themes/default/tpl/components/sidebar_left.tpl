...
<nav class="nav flex-column">
    <a class="nav-link-custom {{ app.request.path == '/' ? 'active' }}" href="{{ url('/') }}"  @click="mobileMenuOpen = false">
    ...
    <a class="nav-link-custom {{ app.request.path starts with '/vip' ? 'active' }}" href="{{ url('/vip') }}"  @click="mobileMenuOpen = false">
